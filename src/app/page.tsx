...
const TESTIMONIALS = [
  ...
  {
    name: '김○○ · 경력 2년',
    text: '면접 준비를 어떻게 해야 할지 방향 자체를 몰랐는데, 이 자료집 하나로 뭘 먼저 해야 하는지 순서가 잡혔습니다.',
    company: 'IT 기업 최종 합격',
  },
]
...
const FAQS = [
  ...
  {
    q: '어떤 내용이 담겨있나요?',
    a: '기술면접 대비 훈련 시스템(3-WAY), 실제 면접 질문별 상세 답변 예시, 기술면접 준비 방향성을 담았습니다.',
  },
  {
    q: 'PDF를 언제 받을 수 있나요?',
          ...
          <div className="mx-auto max-w-2xl">
            ...
            <ul className="space-y-4">
              {[
                ...
                '기술면접 대비 방향이 잡힙니다 — 무엇을 어떤 순서로 준비해야 하는지, 처음부터 방향을 제대로 잡는 방법을 담았습니다.',
                '합격 답변 구조를 바로 쓸 수 있습니다 — 실제 면접에서 나올 수 있는 질문별 상세 답변 구조 예시를 자료구조·OS·네트워크·DB·Spring 영역별로 수록했습니다.',
              ].map((item) => (
